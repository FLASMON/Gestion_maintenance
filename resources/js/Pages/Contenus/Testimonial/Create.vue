<template>
    <AuthenticatedLayout title="Bon de sortie" :sous_title="testimonials?.id ? 'Edit Bon de sortie' : 'Create Bon de sortie'"
                         selected-menu="testimonial">
        <a-form
            :model="formPage"
            name="validate_other"
            layout="vertical"
                                            ...
                                            <template #summary>
                                                <a-table-summary-row class="bg-gray-50">
                                                    ...
                                                    <a-table-summary-cell
                                                        class="bg-[#EAFFEA] border border-gray-400 mb-2 text-center text-base font-bold">
                                                        {{ totalAmount }} Ar
                                                    </a-table-summary-cell>
                                                ...
                                                <a-table-summary-row class="bg-gray-50">
                                                    ...
                                                    <a-table-summary-cell class="text-right">
                                                        <a-typography-title :level="4">Versement :</a-typography-title>
                                                    </a-table-summary-cell>
                                                    <a-table-summary-cell
                            ...
                            <div class="px-4 py-3 bg-white shadow-sm sm:rounded-md">
                                <a-form-item name="image" label="Format Imprimer" class="font-medium">
                                    ...
                                    <a-space direction="vertical" class="font-normal">
                                        ...
                                        <a-checkbox value="E">Valider</a-checkbox>
                                    </a-space>
