                    ...
                    <a-tabs v-model:activeKey="activeKey">
                        ...
                        <a-tab-pane key="2" tab="Information Avancée" force-render class="p-0 -mt-4 sm:rounded-md">
                            <div class="p-4 sm:p-8 mb-6 bg-white shadow-sm sm:rounded-b-md sm:rounded-t-none">
                                <a-row  :gutter="[16, 0]">
                                    <a-col :span="24">
                                        <a-form-item label="N° Carte d'Itentité National" required name="num_cin" :rules="rules.name">
                                    ...
                                    <a-col :span="24" :md="12">
                                        <a-form-item label="Profession" name="profession" :rules="rules.profession">
                                            <a-input v-model:value="formPage.profession" autocomplete="off" size="large">
                                                <template #prefix>
                                                    <font-awesome-icon icon="fa-solid fa-pager"
                                                                       style="color: rgba(0, 0, 0, 0.5)" class="me-4"/>
                                                </template>
                                    ...
                                    <a-col :span="24" :md="12">
                                        <a-form-item label="Téléphone 2" name="telephone2" :rules="rules.telephone2">
                                            <a-input v-model:value="formPage.telephone2" autocomplete="off" size="large">
                                                <template #prefix>
                                                    <font-awesome-icon icon="fa-solid fa-pager"
                                                                       style="color: rgba(0, 0, 0, 0.5)" class="me-4"/>
                                                </template>
                                    ...
                                    <a-col :span="24" :md="12">
                                        <a-form-item label="Téléphone 3" name="telephone3" :rules="rules.telephone3">
                                            <a-input v-model:value="formPage.telephone3" autocomplete="off" size="large">
                                                <template #prefix>
                                                    <font-awesome-icon icon="fa-solid fa-pager"
                                                                       style="color: rgba(0, 0, 0, 0.5)" class="me-4"/>
                                                </template>
                                    ...
                                    <a-col :span="24">
                                        ...
                                        <a-switch
                                            v-if="formPage.status !== 'societe'"
                                            v-model:checked="showFormPassport"
                                            checked-children="Show Passport"
                                            un-checked-children="Hide Passport"
                                            @change="toggleTextEditor"
                                        />
                                    </a-col>
                                </a-row>
                            </div>

                            <div v-if="showFormPassport" class="p-4 sm:p-8 mb-6 bg-white shadow-sm sm:rounded-b-md sm:rounded-t-none">
                                <a-typography-title :level="5" class="pb-4">Passport / Registre commerce</a-typography-title>
                                <a-row  :gutter="[16, 0]">
                                    <a-col :span="24">
                                        <a-form-item label="Client" required name="client" :rules="rules.name">
                                            <a-input v-model:value="formPage.name" autocomplete="off" size="large">
